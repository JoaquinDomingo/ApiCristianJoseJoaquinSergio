...
class ConsoleRepositoryImpl : ConsoleRepository {
    ...
    Console(
        ...
        "1983",
        "Nintendo",
        "Una consola de 8 bits que revitalizó la industria del videojuego.",
    ...
    Console(
        ...
        "1990",
        "Nintendo",
        "Consola de 16 bits famosa por sus títulos legendarios.",
    ...
    Console(
        ...
        "1996",
        "Nintendo",
        "Primera consola de Nintendo con gráficos en 3D reales.",
    ...
    Console(
        ...
        "1994",
        "Sony",
        "Consola de 32 bits que lanzó a Sony al éxito mundial.",
    ...
    Console(
        ...
        "2006",
        "Sony",
        "Soporte HD y Blu-ray, revolucionando el multimedia.",
        "https://i.blogs.es/746491/ps3/840_560.jpg",
        nativeGames = listOf(
        ...
        adaptedGames = listOf(
            Game("Red Dead Redemption", "2010", "Western épico.", "https://m.media-amazon.com/images/I/817vI+Uz2UL.jpg"),
            Game("BioShock", "2007", "Shooter narrativo.", "https://m.media-amazon.com/images/I/81X3RykCZCL._AC_UF894,1000_QL80_.jpg")
        )
    ),
    Console(
        "Xbox",
        "2001",
        "Microsoft",
        "Pionera con Xbox Live y hardware potente.",
    ...
    Console(
        ...
        "2005",
        "Microsoft",
        "Consolidó el juego online y las grandes franquicias.",
    ...
    Console(
        ...
        "1988",
        "Sega",
        "Consola de 16 bits conocida por Sonic.",
        "https://upload.wikimedia.org/wikipedia/commons/thumb/e/e9/Sega-Mega-Drive-JP-Mk1-Console-Set.jpg/1200px-Sega-Mega-Drive-JP-Mk1-Console-Set.jpg",
        nativeGames = listOf(
    ...
    Console(
        ...
        "2001",
        "Nintendo",
        "Consola compacta con discos mini-DVD.",
    ...
    override suspend fun updateConsole(name: String, update: UpdateConsole): Console? {
        ...
        update.nativeGames?.let { console.nativeGames = it }
        update.adaptedGames?.let { console.adaptedGames = it }
    ...
    override suspend fun addGameToConsole(
        ...
        // 1. Buscamos la consola por su nombre
        val console = consoles.find { it.name.equals(consoleName, ignoreCase = true) }
            ?: return false // Si no existe, devolvemos false

        // 2. Creamos una nueva lista basada en la actual y añadimos el juego
        // (Importante: Las listas en la data class Console deben ser mutables o la clase debe permitir reasignar)
        if (isNative) {
            val newList = console.nativeGames.toMutableList()
            newList.add(game)
            console.nativeGames = newList
        } else {
            val newList = console.adaptedGames.toMutableList()
            newList.add(game)
            console.adaptedGames = newList
        }
